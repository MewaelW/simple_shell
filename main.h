...
extern char **environ;
/**
 * struct data - Contains all the data needed during runtime
 *
 * @av: arg vector
 * @input: Written command line
...
/**
 * struct sep_list_s - A single linked list
 *
 * @separator: ;, |, &
 * @next: next node
...
/**
 * struct builtin_s - This is a Builtin struct for command args
 *
 * @name: name of commnad
 * @f: data type pointer func
 */
